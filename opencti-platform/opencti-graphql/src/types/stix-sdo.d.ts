...
interface StixAttackPattern extends StixDomainObject {
  ...
  cwe_id: string;
  cwe_related_weaknesses: string;
  cwe_modes_introduction_text: string;
  cwe_exploit_likelihood: string;
  cwe_common_consequences_scope: string;
  cwe_detection_methods_description: string;
  cwe_potential_mitigations_description: string;
  cwe_demonstrative_exemples: string;
  extensions: {
...
interface StixMalware extends StixDomainObject {
  ...
  malware_cve: string;
  malware_type_exploit: string;
  malware_platform: string;
  malware_verified: string;
  malware_code: string;
  malware_risk: string;
  malware_local: string;
  malware_remote: string;
}
