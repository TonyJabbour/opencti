...
interface BasicStoreEntity extends StoreProxyEntity {
  ...
  x_opencti_cpe: string;
  x_opencti_raw_cpe: string;
  x_opencti_related_cpe: string;
  ...
  x_opencti_cwe_id: string;
  x_opencti_cwe_related_weaknesses: string;
  x_opencti_cwe_modes_introduction_text: string;
  x_opencti_cwe_exploit_likelihood: string;
  x_opencti_cwe_common_consequences_scope: string;
  x_opencti_cwe_detection_methods_description: string;
  x_opencti_cwe_potential_mitigations_description: string;
  x_opencti_cwe_demonstrative_exemples: string;
  x_opencti_cpe23: string;
  x_opencti_product: string;
  x_opencti_version: string;
  x_opencti_vendor: string;
  x_opencti_malware_cve: string;
  x_opencti_malware_type_exploit: string;
  x_opencti_malware_platform: string;
  x_opencti_malware_verified: string;
  x_opencti_malware_code: string;
  x_opencti_malware_local: string;
  x_opencti_malware_risk: string;
  x_opencti_malware_remote: string;
  x_opencti_cpe_cpe23: string;
  x_opencti_cpe_product: string;
  x_opencti_cpe_version: string;
  x_opencti_cpe_vendor: string;
  // rels
...
interface BasicStoreCyberObservable extends BasicStoreCommon {
  ...
  x_opencti_abuseipdb_confidence: string;
  x_opencti_abuseipdb_country: string;
  x_opencti_abuseipdb_isp: string;
  path: string;
  path_enc: string;
  rir: string;
  name_enc: string;
