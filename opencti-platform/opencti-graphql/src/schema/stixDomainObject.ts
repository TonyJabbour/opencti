...
export const stixDomainObjectFieldsToBeUpdated: { [k: string]: Array<string> } = {
  [ENTITY_TYPE_ATTACK_PATTERN]: [
    ...
    'aliases',
    'x_opencti_cwe_id',
    'x_opencti_cwe_related_weaknesses',
    'x_opencti_cwe_modes_introduction_text',
    'x_opencti_cwe_exploit_likelihood',
    'x_opencti_cwe_common_consequences_scope',
    'x_opencti_cwe_detection_methods_description',
    'x_opencti_cwe_potential_mitigations_description',
    'x_opencti_cwe_demonstrative_exemples',
  ],
  ...
  [ENTITY_TYPE_INFRASTRUCTURE]: ['name', 'revoked', 'description', 'confidence', 'aliases', 'x_opencti_cpe_cpe23', 'x_opencti_cpe_product', 'x_opencti_cpe_version', 'x_opencti_cpe_vendor'],
  [ENTITY_TYPE_INTRUSION_SET]: [
    'name',
    'revoked',
    'description',
  ...
  [ENTITY_TYPE_MALWARE]: ['name', 'revoked', 'description', 'is_family', 'malware_types', 'confidence', 'aliases', 'x_opencti_malware_cve', 'x_opencti_malware_type_exploit', 'x_opencti_malware_platform', 'x_opencti_malware_verified', 'x_opencti_malware_code', 'x_opencti_malware_risk', 'x_opencti_malware_local', 'x_opencti_malware_remote'],
  [ENTITY_TYPE_THREAT_ACTOR]: [
    'name',
    'revoked',
    'description',
...
export const stixDomainObjectsAttributes: { [k: string]: Array<string> } = {
  ...
  [ENTITY_TYPE_INFRASTRUCTURE]: [
    ...
    'x_opencti_workflow_id',
    'x_opencti_cpe_cpe23', 
    'x_opencti_cpe_product', 
    'x_opencti_cpe_version', 
    'x_opencti_cpe_vendor',
  ],
  [ENTITY_TYPE_INTRUSION_SET]: [
    'internal_id',
    'standard_id',
  ...
  [ENTITY_TYPE_MALWARE]: [
    ...
    'x_opencti_graph_data',
    'x_opencti_workflow_id',
    'x_opencti_malware_cve',
    'x_opencti_malware_type_exploit',
    'x_opencti_malware_platform',
    'x_opencti_malware_verified',
    'x_opencti_malware_code',
    'x_opencti_malware_risk',
    'x_opencti_malware_local',
    'x_opencti_malware_remote',
  ],
  [ENTITY_TYPE_THREAT_ACTOR]: [
    'internal_id',
    'standard_id',
