...
export const buildInputDataFromStix = (stix: StixObject): unknown => {
  ...
  if (type === ENTITY_TYPE_ATTACK_PATTERN) {
    ...
    const input:AttackPatternAddInput = {
      ...
      x_opencti_cwe_id: attack.cwe_id,
      x_opencti_cwe_related_weaknesses: attack.cwe_related_weaknesses,
      x_opencti_cwe_modes_introduction_text: attack.cwe_modes_introduction_text,
      x_opencti_cwe_exploit_likelihood: attack.cwe_exploit_likelihood,
      x_opencti_cwe_common_consequences_scope: attack.cwe_common_consequences_scope,
      x_opencti_cwe_detection_methods_description: attack.cwe_detection_methods_description,
      x_opencti_cwe_potential_mitigations_description: attack.cwe_potential_mitigations_description,
      x_opencti_cwe_demonstrative_exemples: attack.cwe_demonstrative_exemples,
      update: true,
    };
    return input;
  }
  ...
  if (type === ENTITY_TYPE_INFRASTRUCTURE) {
    ...
    const input:InfrastructureAddInput = {
      ...
      x_opencti_cpe_cpe23: infra.cpe_cpe23,
      x_opencti_cpe_product: infra.cpe_product,
      x_opencti_cpe_version: infra.cpe_version,
      x_opencti_cpe_vendor: infra.cpe_vendor,
      update: true
    };
    return input;
  }
  ...
  if (type === ENTITY_TYPE_MALWARE) {
    ...
    const input:MalwareAddInput = {
      ...
      update: true,
      x_opencti_malware_cve: malware.malware_cve,
      x_opencti_malware_type_exploit: malware.malware_type_exploit,
      x_opencti_malware_platform: malware.malware_platform,
      x_opencti_malware_verified: malware.malware_verified,
      x_opencti_malware_code: malware.malware_code,
      x_opencti_malware_remote: malware.malware_remote,
      x_opencti_malware_local: malware.malware_local,
      x_opencti_malware_risk: malware.malware_risk
    };
    return input;
  }
  ...
  if (type === ENTITY_TYPE_VULNERABILITY) {
    ...
    const input:VulnerabilityAddInput = {
      ...
      x_opencti_cwe: vulnerability.extensions[STIX_EXT_OCTI].cwe,
      x_opencti_cpe: vulnerability.extensions[STIX_EXT_OCTI].cpe,
      x_opencti_raw_cpe: vulnerability.extensions[STIX_EXT_OCTI].raw_cpe,
      x_opencti_related_cpe: vulnerability.extensions[STIX_EXT_OCTI].related_cpe,
