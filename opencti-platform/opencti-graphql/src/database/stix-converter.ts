  ...
  return {
    ...
    extensions: {
      [STIX_EXT_OCTI]: cleanObject({
        ...
        cpe: instance.x_opencti_cpe,
        raw_cpe: instance.x_opencti_raw_cpe,
        related_cpe: instance.x_opencti_related_cpe,
      })
    }
  };
};
...
const convertInfrastructureToStix = (instance: StoreEntity, type: string): SDO.StixInfrastructure => {
  ...
  return {
    ...
    first_seen: instance.first_seen,
    last_seen: instance.last_seen,
    cpe_cpe23: instance.x_opencti_cpe_cpe23,
    cpe_product: instance.x_opencti_cpe_product,
    cpe_version: instance.x_opencti_cpe_version,
    cpe_vendor: instance.x_opencti_cpe_vendor,
  };
};
...
const convertMalwareToStix = (instance: StoreEntity, type: string): SDO.StixMalware => {
  ...
  return {
    ...
    malware_cve: instance.x_opencti_malware_cve,
    malware_type_exploit: instance.x_opencti_malware_type_exploit,
    malware_platform: instance.x_opencti_malware_platform,
    malware_verified: instance.x_opencti_malware_verified,
    malware_code: instance.x_opencti_malware_code,
    malware_risk: instance.x_opencti_malware_risk,
    malware_local: instance.x_opencti_malware_local,
    malware_remote: instance.x_opencti_malware_remote,
...
const convertAttackPatternToStix = (instance: StoreEntity, type: string): SDO.StixAttackPattern => {
  ...
  return {
    ...
    aliases: instance.aliases,
    kill_chain_phases: buildKillChainPhases(instance),
    cwe_id: instance.x_opencti_cwe_id,
    cwe_related_weaknesses: instance.x_opencti_cwe_related_weaknesses,
    cwe_modes_introduction_text: instance.x_opencti_cwe_modes_introduction_text,
    cwe_exploit_likelihood: instance.x_opencti_cwe_exploit_likelihood,
    cwe_common_consequences_scope: instance.x_opencti_cwe_common_consequences_scope,
    cwe_detection_methods_description: instance.x_opencti_cwe_detection_methods_description,
    cwe_potential_mitigations_description: instance.x_opencti_cwe_potential_mitigations_description,
    cwe_demonstrative_exemples: instance.x_opencti_cwe_demonstrative_exemples,
    extensions: {
      [STIX_EXT_OCTI]: buildOCTIExtensions(instance),
      [STIX_EXT_MITRE]: buildMITREExtensions(instance)
    }
...
const convertIPv4AddressToStix = (instance: StoreCyberObservable, type: string): SCO.StixIPv4Address => {
  ...
  return {
    ...buildStixCyberObservable(instance),
    value: instance.value,
    x_opencti_abuseipdb_confidence: instance.x_opencti_abuseipdb_confidence,
    x_opencti_abuseipdb_country: instance.x_opencti_abuseipdb_country,
    x_opencti_abuseipdb_isp: instance.x_opencti_abuseipdb_isp,
    resolves_to_refs: (instance[INPUT_RESOLVES_TO] ?? []).map((m) => m.standard_id),
